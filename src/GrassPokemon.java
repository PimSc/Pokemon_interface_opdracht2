...
public class GrassPokemon extends Pokemon {
    ...
    public void leafStorm (Pokemon name, Pokemon enemy){
        ...
        switch (enemy.getType()){
            case "Grass":{System.out.println(enemy.getName() + " loses 3hp");
                enemy.setHp(enemy.getHp() -3);}
            case "Fire":{System.out.println(enemy.getName() + " loses 10hp");
                enemy.setHp(enemy.getHp() -10);}
            case "Electric":{System.out.println(enemy.getName() + " loses 15");
